                        ...
                        <div className="col-lg-6">
                            <div className="about-content pb-5">
                                <div className="section-heading">
                                    ...
                                    <h2 className="section__title">Benefits of Learning With On-Study</h2>
                                ...
                                <div className="row pt-4 pb-3">
                                    <div className="col-lg-4 responsive-column-half">
                                        <div className="info-icon-box mb-3">
                                            <div className="icon-element icon-element-md shadow-sm">
                                            ...
                                            <h4 className="fs-20 font-weight-semi-bold pt-3">130,000 Courses</h4>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 responsive-column-half">
                                        <div className="info-icon-box mb-3">
                                            <div className="icon-element icon-element-md shadow-sm">
                                                <svg className="svg-icon-color-2" width="32" viewBox="0 0 512 512"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <g>
                                                        <path
                                            ...
                                            <h4 className="fs-20 font-weight-semi-bold pt-3">Live Learning</h4>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 responsive-column-half">
                                        <div className="info-icon-box mb-3">
                                            <div className="icon-element icon-element-md shadow-sm">
                                                <svg className="svg-icon-color-3" width="32" version="1.1"
                                            ...
                                            <h4 className="fs-20 font-weight-semi-bold pt-3">Expert Teachers</h4>
                                        </div>
                                    </div>
                                </div>
                                <div className="btn-box">
                                    <a href="#"
                                       className="btn theme-btn">Sign Up <i className="la la-arrow-right icon ml-1"></i></a>
                                </div>
                            </div>
                        </div>
