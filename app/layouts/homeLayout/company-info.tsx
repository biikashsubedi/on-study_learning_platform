export default function Index() {
    return (
        <>
            <section className="funfact-area text-center overflow-hidden pt-20px pb-80px dot-bg">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-1" width="40" viewBox="0 0 512 512"
                                ...
                                <h4 className="counter__title counter text-color-2">7520</h4>
                                <p className="counter__meta">expert instructors</p>
                            </div>
                        </div>
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-2" width="42" version="1.1"
                                         xmlns="http://www.w3.org/2000/svg"
                                         x="0px" y="0px" viewBox="0 0 480.1 480.1" xmlSpace="preserve">
                                        <g>
                                            <g>
                                ...
                                <h4 className="counter__title counter text-color-3">54,252</h4>
                                <p className="counter__meta">foreign followers</p>
                            </div>
                        </div>
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-3" width="42" version="1.1"
                                         xmlns="http://www.w3.org/2000/svg"
                                         x="0px" y="0px" viewBox="0 0 490.667 490.667" xmlSpace="preserve">
                                        <g>
                                            <g>
                                ...
                                <h4 className="counter__title counter text-color-4">97,220</h4>
                                <p className="counter__meta">students enrolled</p>
                            </div>
                        </div>
                        <div className="col-lg-3 responsive-column-half">
                            <div className="counter-item">
                                <div className="counter__icon icon-element mb-3 shadow-sm">
                                    <svg className="svg-icon-color-4" width="40" viewBox="0 0 512 512"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <path
                                ...
                                <h4 className="counter__title counter text-color-5">20</h4>
                                <p className="counter__meta">years of experience</p>
                            </div>
                        </div>
                    </div>
                </div>
