                        ...
                        <div className="col-lg-5">
                            <div className="card card-item">
                                <div className="card-body">
                                    <h3 className="fs-24 font-weight-semi-bold pb-2">Contact us</h3>
                                    ...
                                    <form method="post">
                                        ...
                                        <div className="input-box">
                                            ...
                                            <div className="form-group">
                                                <input className="form-control form--control" type="text" name="phone"
                                        ...
                                        <div className="input-box">
                                            ...
                                            <div className="form-group">
                                                <input className="form-control form--control" type="text" name="subject"
                                                       placeholder="Subject"/>
                                                <span className="la la-book input-icon"></span>
                                            </div>
                                        </div>
                                        <div className="btn-box pt-2">
                                            <button className="btn theme-btn" type="submit">Submit <i
                        ...
                        <div className="col-lg-6 ml-auto">
                            <div className="register-content">
                                <div className="section-heading">
                                    <h5 className="ribbon ribbon-lg mb-2">Register</h5>
                                    <h2 className="section__title">Get ahead with Learning Paths. Stay Sharp.</h2>
                                    <span className="section-divider"></span>
                                    <p className="section__desc">Education is the process of acquiring the body of
                                        knowledge and skills
                                        that people are expected have in your society. A education develops a critical
                                        thought
                                        process in addition to learning. Bimply dummy text of the printing and
                                        typesetting istryrem
                                        Ipsum has been the industry’s standard dummy text ever since the 1500s, when an
                                        unknown
                                        printer Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam
                                        aliquid architecto
                                        aspernatur, facilis perspiciatis rerum saepe vel vitae? Alias culpa dicta facere
                                        maiores
                                        quam quas, quis sapiente voluptatem? Nulla, voluptatem.</p>
                                </div>
                                <div className="btn-box pt-35px">
                                    <a href="#"
                                       className="btn theme-btn"><i className="la la-user mr-1"></i>Login</a>
                                </div>
                            </div>
                        </div>
                    </div>
