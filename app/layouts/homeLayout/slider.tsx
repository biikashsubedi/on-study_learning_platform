export default function Index() {
    return (
        <>
            <section className="hero-area position-relative hero-area-2"
                     style={{backgroundImage: 'url("/assets/home/images/slider-img1.jpg")'}}>
                <div className="hero-slider-item hero-bg-4">
                    <div className="container">
                        <div className="hero-content">
                            <div className="section-heading">
                                <h2 className="section__title text-white fs-55 lh-60 pb-3 cd-headline zoom">
                                    Find
                                    <span className="cd-words-wrapper" style={{width: '359.703px'}}>
                            <b className="is-hidden">Your Dream</b>
                        </span>
                                    Subject
                                </h2>
                                <p className="section__desc text-white pb-4">Choose from over 50,000 mcq sets with new
                                    additions
                                    <br/>updated by our instructor every week
                                </p>
                            </div>
                            <form method="post" className="w-50 pt-2">
                    ...
                    <div className="hero-feature-wrap bg-gradient overflow-hidden">
                        <span className="ring-shape ring--shape ring-shape-1"></span>
                        <span className="ring-shape ring--shape ring-shape-2"></span>
                        <span className="ring-shape ring--shape ring-shape-3"></span>
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-4 responsive-column-half">
                                    <div className="info-icon-box d-flex align-items-center py-4">
                                        <div className="icon-element icon-element-md flex-shrink-0 mr-3">
                                            <svg className="svg-icon-color-1" width="32" viewBox="0 0 512 512"
                                        ...
                                        <div>
                                            <h4 className="fs-20 font-weight-bold text-white">50,000 Online MCQ</h4>
                                            <p className="text-white">Explore a variety of fresh sets</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 responsive-column-half">
                                    <div className="info-icon-box d-flex align-items-center py-4">
                                        <div className="icon-element icon-element-md flex-shrink-0 mr-3">
                                            <svg className="svg-icon-color-2" width="32" version="1.1"
                                                 xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                 viewBox="0 0 490.667 490.667" xmlSpace="preserve">
                                                <g>
                                                    <g>
                                        ...
                                        <div>
                                            <h4 className="fs-20 font-weight-bold text-white">Best way of learning</h4>
                                            <p className="text-white">Find the right topics for you</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 responsive-column-half">
                                    <div className="info-icon-box d-flex align-items-center py-4">
                                        <div className="icon-element icon-element-md flex-shrink-0 mr-3">
                                            <svg className="svg-icon-color-3" viewBox="0 0 24 24" width="32"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path
                                                ...
                                                <g>
                                                    <path
                                                        d="m11.5 16.5c-.128 0-.256-.049-.354-.146-.195-.195-.195-.512 0-.707l3.647-3.647-3.646-3.646c-.195-.195-.195-.512 0-.707s.512-.195.707 0l4 4c.195.195.195.512 0 .707l-4 4c-.098.097-.226.146-.354.146z"></path>
                                                </g>
                                                <g>
                                                    <path
                                        ...
                                        <div>
                                            <h4 className="fs-20 font-weight-bold text-white">Lifetime free access</h4>
