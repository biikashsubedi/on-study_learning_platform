!function (e) {
    ...
    t.on("load", function (a, o) {
        var s = e(document), i = e("html, body"), l = e(".preloader"), n = e(".toggle-password"), r = e(".hero-slider"),
            c = e(".course-carousel"), d = e(".view-more-carousel"), u = e(".view-more-carousel-2"),
            m = e(".testimonial-carousel1"), g = e(".testimonial-carousel-2"), p = e(".testimonial-carousel-3"),
            v = e(".client-logo-carousel"), h = e(".blog-post-carousel"), f = e(".select-container-select"),
            y = e(".card-preview"), b = e(".user-text-editor"), w = e(".category-carousel"),
            k = e(".featured-course-carousel"), C = e(".fullscreen-slider"), S = e(".generic-portfolio-list"),
            x = e('[data-fancybox="gallery"]'), T = e(".datepicker"), q = e(".emoji-picker"), H = e(".counter"),
            L = e(".tags-input"), I = e(".qtyBtn"), j = e("#phone"), z = e(".cv-input"), M = e(".lazy"),
            P = e(".skillbar");
        ...
        t.on("scroll", function () {
            ...
            smartSpeed: 500,
            autoplay: !0,
            responsive: {0: {items: 2}, 481: {items: 3}, 768: {items: 4}, 992: {items: 5}}
            ...
            percentPosition: !0,
            masonry: {columnWidth: ".generic-portfolio-item", horizontalOrder: !0}
            ...
            delay: 100,
            animation: "swing"
        }), e(b).length && e(b).jqte({formats: [["p", "Paragraph"], ["h1", "Heading 1"], ["h2", "Heading 2"], ["h3", "Heading 3"], ["h4", "Heading 4"], ["h5", "Heading 5"], ["h6", "Heading 6"], ["pre", "Preformatted"]]}), e(T).length && e(T).dateDropper({
            format: "d-m-Y",
            theme: "vanilla",
            large: !0,
            largeDefault: !0
        }), e(q).length && e(q).emojioneArea({pickerPosition: "top"}), e(H).length && e(H).counterUp({
            delay: 10,
            time: 1e3
            ...
            var t = e(this), a = t.parent().find(".qtyInput").val();
            if (t.hasClass("qtyInc")) var o = parseFloat(a) + 1; else o = a > 0 ? parseFloat(a) - 1 : 0;
        ...
        const F = document.querySelector(".copy-input"), N = document.querySelector(".copy-btn"),
        ...
        }), e(z).length && e(z).MultiFile({accept: "pdf, doc, docx, rtf, html, odf, zip"}), e(M).length && e(M).Lazy();
        var B, Q = document.querySelector("#send-message-btn"), W = e(".contact-form"),
        ...
        W.submit(function (t) {
            t.preventDefault(), B = e(this).serialize(), Q.innerHTML = "Sending...", setTimeout(function () {
                e.ajax({type: "POST", url: W.attr("action"), data: B}).done(_).fail(G)
            }, 2e3)
        });
        // const J = document.querySelectorAll(".theme-picker-btn"), K = window.matchMedia("(prefers-color-scheme: dark)"),
        ...
        //     e(this).find(".skillbar-bar").animate({width: e(this).attr("data-percent")}, 6e3)
        // })
    })
}(jQuery);